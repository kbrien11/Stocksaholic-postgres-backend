...
if ENV =='dev':
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:F*GE5GFG6-*CD-gc-CE1gbAedFegcDcc@monorail.proxy.rlwy.net:21891/railway'
